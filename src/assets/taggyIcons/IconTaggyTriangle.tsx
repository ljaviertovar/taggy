...
const IconTaggyTriangle = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => (
	...
	>
		...
		/>
		<defs>
			<linearGradient id='gradient' x1='50%' y1='0%' x2='50%' y2='100%' strokeWidth='2'>
				<stop offset='0%' stopColor='#ff3385'>
					<animate
						attributeName='stop-color'
						values='#ff3385; #5EAD27; #ff3385'
						dur='1s'
						repeatCount='indefinite'
					></animate>
				</stop>
				<stop offset='100%' stopColor='#5EAD27'>
					<animate
						attributeName='stop-color'
						values='#5EAD27; #ff3385; #5EAD27'
						dur='1s'
						repeatCount='indefinite'
					></animate>
				</stop>
